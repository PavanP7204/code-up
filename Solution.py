...
blocks1 = [ { "gym" : True, "school" : False, "store" : False } ,{ "gym" : False, "school" : True, "store" : False } ,{ "gym" : False, "school" : True, "store" : True } ,{ "gym" : True, "school" : True, "store" : False } ,{ "gym" : False, "school" : True, "store" : True } ]

reqs1 = [ "school","store" ]

print(appartmentHunting(blocks1,reqs1))
